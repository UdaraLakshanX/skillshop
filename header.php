     ...
     <nav class="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center gap-6">
            ...
            <!-- Logo -->
             ...
             text-transparent hover:opacity-80 transition-opacity flex-shrink-0">SkillShop</a>
            ...
            <div class="hidden md:flex flex-1 max-w-lg items-center gap-2">
                    <form method="GET" action="search-products.php" class="relative flex-1">
                        <input type="text" name="q" placeholder="Search, skills, instructors,.." class="w-full px-4 py-2.5 bg-gray-50 border
                        border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent 
                    ...
                    <a href="advance-search-products.php" class="px-4 py-2 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors 
                    text-sm font-medium">Advanced Search</a>
            </div>
              ...
              <!-- Right Section -->
               <div class="flex gap-1 sm:gap-2 items-center">
                    <?php if ($loggedIn): ?>
                        ...
                        <!-- Notifications -->
                         <div class="relative group hidden sm:block">
                            <button class="relative p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg 
                            transition-colors duration-200">
                                🔔
                                <span class="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full animate-pulse"></span>
                            </button>

                            <div class="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                         ...
                         <!-- Cart/Watchlist for Buyers -->
                          <?php if($userRole == "buyer"): ?>
                            <a href="buyer-dashboard.php?tab=cart" class="relative p-2 text-gray-600
                                ...
                                🛒
                                <?php if($cartCount > 0): ?>
                                    <span id="cart-count" class="absolute top-1 right-1 text-xs bg-blue-600 text-white w-5 h-5 rounded-full flex items-center justify-center font-bold text-xs"><?= $cartCount; ?></span>
                                <?php else: ?>
                                    <span id="cart-count" class="absolute top-1 right-1 text-xs bg-blue-600 text-white w-5 h-5 rounded-full flex items-center justify-center font-bold text-xs">0</span>
                                <?php endif; ?>
                            </a>
                          ...
                          <!-- Profile Dropdown -->
                           <div class="relative ml-2 sm:ml-4 pl-2 sm:pl-4 border-l border-gray-200">
                                <button class="flex items-center gap-2 hover:bg-gray-50 px-2 py-1 
                                rounded-lg transition-colors duration-200" id="profileBtn">
                                    <img src="assets/images/avatar.png" class="w-8 h-8 rounded-full ring-2 ring-transparent
                                ...
                                <!-- Dropdown menu -->
                                 <div id="profileDropdown" class="absolute right-0 mt-3 w-56 bg-white rounded-lg shadow-lg border
                                 border-gray-100 opacity-0 invisible transition-all duration-200" style="display:none;">
                                    <div class="p-4 border-b border-gray-100">
                                    ...
                                    <div class="py-2">
                                        ...
                                        <?php if($userRole == "buyer"): ?>
                                            <a href="buyer-dashboard.php?tab=purchase-history" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-150" title="Purchase HIstory">📜 Puchase History</a>
                                            <a href="watchlist.php" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-150">❤️ Watchlist</a>
                                        <?php endif; ?>
                                        <a href="user-profile.php" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50
                                        hover:text-blue-600 transition-colors duration-150">👤 My Profile</a>
                                        <a href="process/logoutProcess.php" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50
                                        hover:text-blue-600 transition-colors duration-150">🚪 Sign Out</a>
                                    </div> 
                                 </div>
                    ...
                    <?php else: ?>
                        ...
                        <a href="index.php" class="bg-gradient-to-r from-blue-600 to-indigo-600 
                        text-white px-4 py-2 rounded-lg hover:shadow-lg hover:from-blue-700 hover:to-indigo-700
                        font-medium transition-all text-sm">Join</a>

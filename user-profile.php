             ...
             <form id="profileForm" class="space-y-8">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="flex items-center space-x-6">
                        <img id="avatarPreview" src="<?php echo $avatarUrl; ?>" class="w-24 h-24 rounded-full object-cover border-2 border-gray-200" />
                        <div>
                   ...
                   <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                focus:ring-blue-500 focus:border-transparent outline-none transition"><?php echo $profile ? $profile["bio"] : ""; ?></textarea>
                   ...
                   <!-- Address Information -->
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="line1" name="line1" value="<?php echo $profile ? $profile["line1"] : "";?>" 
                            ...
                            <div>
                                ...
                                <input type="text" id="line2" name="line2" value="<?php echo $profile ? $profile["line2"] : "";?>" 
                    ...
                    <!-- Form Actions -->
                     <div class="flex gap-4 justify-end">
                        ...
                        <button type="submit" id="saveBtn" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors ">
                            Save Changes
                        </button>
                     </div>

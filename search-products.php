...
// Fetch products
$productsQuery = "  SELECT  p.`id`, p.`title`, p.`description`, p.`image_url`, p.`level`, p.`price`, p.`created_at`,
     ...
     <section class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-10 md:py-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" action="search-products.php" class="max-w-2xl mx-auto flex gap-2">
                ...
                value="<?php echo $searchQuery; ?>" class="flex-1 px-5 py-3 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm" autocomplete="off"/>
                ...
                <?php foreach($products as $product): 
                    ...
                    overflow-hidden flex flex-col border border-gray-100 group">
                            ...
                            <?php else:?>
                                <div class="w-full h-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center">
                                    <svg class="w-14 h-14 text-blue-300" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4.5-4.5 3 3 4.5-4.5L16 15z"></path>
                                    </svg>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            ...
                            <!-- Title -->
                            <h3 class="font-bold text-gray-900 text-sm leading-snug line-clamp-2 mb-2 group-hover:text-blue-600 transition-colors"><?php echo $product["title"]; ?></h3>
                            ...
                            <div class="flex items-center justify-between text-xs mb-3 pb-3 border-b border-gray-100">
                                ...
                                <span class="font-medium text-gray-600"><?php echo intval($product["customer_count"]); ?> Customers</span>
                            </div>
            ...
            <?php if($totalPages > 1): ?>
                <nav class="flex justify-center items-center gap-1 mt-12 mb-8">
                    ...
                    <?php for($i = $start; $i <= $end; $i++): ?>
                        <a href="?q=<?php echo urlencode($searchQuery); ?>&page=<?php echo $i; ?>" class="p-2 text-sm font-medium <?php echo $i == $currentPage ? "bg-blue-600 text-white" : "text-gray-700 hover:bg-blue-50"; ?> rounded-lg transition-colors"><?php echo $i; ?></a>
                    <?php endfor; ?>
        ...
        <?php else: ?>
            ...
            <div class="text-center py-20">
                ...
                <p class="text-gray-600 mb-6">
                    <?php echo !empty($serachQuery) ? "Try different keywords or browse all available skills." : "Try searching for a skill to get started!";?>
                </p>
                <div class="flex gap-3 justify-center">
                    <a href="home.php" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700">Browse All</a>
                    <?php if(!empty($searchQuery)): ?>
                        <a href="search-products.php" class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-bold
                        hover:bg-gray-50 transition-colors">Clear</a>
                    <?php endif; ?>
                </div>
            </div>

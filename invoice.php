...
<body class="bg-gray-50 min-h-screen py-10">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Invoice Paper -->
        <div class="bg-white p-8 md:p-12 rounded-2xl shadow-xl print-shadow-none border border-tranparent print-border">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-10">
                ...
                <div class="md:text-right flex flex-col items-start md:items-end">
                    ...
                    <div class="bg-green-50 text-green-700 px-4 py-2 rounded-lg font-bold text-sm inline-flex items-center gap-2 border broder-green-100 mb-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Footer -->
            <div class="mt-16 pt-8 border-t border-gary-100 text-center text-sm text-gray-500">
                ...
                <p class="mt-4 text-xs font-medium text-gray-400">&copy; <?= date('Y') ?> SkillShop. All rights reserved.</p>
            </div>

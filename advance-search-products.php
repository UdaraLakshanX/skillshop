    ...
    <!-- Search Header -->
     <section class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-10 md:py-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-blue-100 text-center mb-8">Discover experet-led courses across various topics</p>
            ...
            <form method="GET" action="advance-search-products.php" class="max-w-2xl mx-auto flex gap-2">
                ...
                value="<?php echo $filters["q"]; ?>" class="flex-1 px-5 py-3 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm" autocomplete="off"/>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                    ...
                    <form method="GET" class="p-5 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="cat" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-700
                            text-sm rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                            <?php $levels = ["Beginner" => "🟢 Beginner","Intermediate" => "🟡 Intermediate", "Advanced" => "🔴 Advanced"]?>
                                ...
                                <?php endforeach;?>
                                <label class="flex items-center group cursor-pointer">
                                    <input type="radio" name="level" value="" <?php echo empty($filters["level"]) ? "checked" : ""; ?>
                        ...
                        <div>
                            ...
                            <select name="rating" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-700
                            text-sm rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        ...
                        <div>
                            ...
                            <div class="space-y-4 px-1">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    class="w-1/2 px-3 py-2 bg-gray-50 border border-gray-200 text-xs rounded-lg
                        ...
                        <div class="pt-4 space-y-3">
                            <button type="submit" class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold
                            text-sm rounded-xl shadow-md hover:shadow-lg transition-all active:scale-[0.98]">
                                Apply Filters
                            </button>
                            <a href="advance-search-products.php?q=<?php echo $filters["q"] ?>" class="block w-full py-3
                            bg-gray-100 hover:bg-gray-200 text-gray-700 text-center font-bold text-sm rounded-xl transition-all">
                                    Reset
                            </a>
                        </div>
            ...
            <main class="flex-1">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
                     <div class="flex items-center gap-4">
                        ...
                        <button onclick="toggleFilters();" class="lg:hidden flex items-center gap-2 px-4 py-2 bg-white border 
                        border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-all">
                    ...
                    <div class="flex items-center gap-3 bg-white p-1 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <form metho="GET" id="sortForm">
                            <select name="sort" onchange="this.form.submit();" class="pl-2 pr-8 py-2 bg-transparent text-sm
                            font-bold text-gray-700 cursor-pointer focus:outline-none">
                            ...
                            <?php foreach($filters as $k => $v) if($v && $k != "sort") echo "<input type='hidden' name='$k' value='$v' />"; ?>
                        </form>
                    </div>
                ...
                <?php if(count($products) > 0): ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                        <?php foreach($products as $product): 
                            ...
                            <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl 
                            transition-all duration-300 flex flex-col overflow-hidden h-full">
                                <div class="relative aspect-video bg-gray-100 overflow-hidden">
                                    <?php if($product["image_url"]):?>
                                        <img src="<?php echo $product["image_url"]?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"/>
                                    <?php else: ?>
                                    ...
                                    <div class="absolute top-4 left-4">
                                        <span class="px-3 py-1 bg-white/90 backdrop-blur shadow-sm text-blue-700 text-[10px]
                                    ...
                                    ?>
                                        <button type="button" 
                                        class="wl-heart absolute top-2.5 right-2.5 z-20 w-9 h-9 flex items-center
                                        justify-center rounded-full bg-white/90 shadow-md hover:scale-110 active:scale-95 transition-transform <?php echo $inWl ? "text-rose-500" : "text-gray-400 hover:text-rose-400"; ?>"
                                        data-product-id="<?php echo $product["id"]; ?>" 
                                        data-in="<?php echo $inWl ? 1 : 0; ?>"
                                        title="<?php echo $inWl ? "Remove from watchlist" : "Add to watchlist"; ?>"
                                        >

                                            <svg class="w-5 h-5" fill="<?php echo $inWl ? 'currentColor' : 'none'; ?>" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    ...
                                    <h3 class="text-gray-900 font-bold text-base leading-tight mb-3 line-clamp-2
                                    ...
                                    <div class="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-xl font-extrabold text-blue-600">Rs. <?php echo number_format($product["price"], 2); ?></span>
                                        </div>
                                        <a href="procut-view.php?id=<?php echo $product["id"]; ?>" class="p-3 bg-blue-50 text-blue-600
                                        rounded-xl group-hover:bg-blue-600 group-hover:text-white transition-all transform 
                        ...
                        <div class="mt-16 flex justify-center">
                            <nav class="inline-flex items-center gap-2 bg-white p-2 rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <?php if($currentPage > 1): ?>
                                    <a href="?page=<?php echo $currentPage - 1; ?><?php echo $fiterQuery; ?>" class="w-10 h-10 flex items-center
                                    justify-center rounded-xl hover:bg-gray-50 text-gray-500 transition-all">
                                ...
                                <?php for($i = 1; $i <= $totalPages; $i++): ?>
                                    <?php if($i == 1 || $i == $totalPages || ($i >= $currentPage - 1 && $i <= $currentPage + 1)): ?>
                                        <a href="?page=<?php echo $i; ?><?php echo $filterQuery; ?>" class="w-10 h-10 flex items-center
                                        justify-center rounded-xl text-sm font-bold transition-all 
                                ...
                                <?php if($currentPage < $totalPages): ?>
                                    <a href="?page=<?php echo $currentPage + 1; ?><?php echo $filterQuery; ?>" class="w-10 h-10 flex
                                    items-center justify-center rounded-xl hover:bg-gray-50 text-gray-500 transition-all">
                ...
                <?php else: ?>    
                    ...
                    <div class="bg-white rounded-3xl p-12 text-center border border-dashed border-gray-200 shadow-sm max-w-xl mx-auto my-20">
                        ...
                        <p class="text-gray-500 mb-8 leading-realxed">
                            We coludn't find anything matching your filters. Try clearing some options or searching for a different keyword.
                        </p>
                        <a href="advance-search-products.php" class="inline-flex items-center gap-2 px-8 py-3 bg-blue-600
                        hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg transition-all transform active:scale-95">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group text-center p-6 rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <p class="text-sm text-gray-600">Quality eduction that fits your budget</p>
                </div>
            </div>
        </div>
    </section>

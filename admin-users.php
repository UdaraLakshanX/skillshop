                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors user-row">
                                    <td class="px-8 py-5">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center font-bold text-slate-400">
                                    ...
                                    <td class="px-8 py-5 text-right">
                                        <button onclick="toggleUserStatus(<?= $user['id']; ?>);" id="btn-<?= $user["id"]; ?>" class="px-4 py-2 rounded-lg text-xs font-bold transition-all <?= ($user["status"] == "active") ? "bg-red-50 text-red-600 hover:bg-red-600 hover:text-white" : "bg-green-600 text-white hover:bg-green-700"; ?>">

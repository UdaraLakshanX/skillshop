...
// GET Featured Products form the Database
    ...
    <!-- Featured Carousel -->
     <section id="browse" class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative group">
                                ...
                                <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all h-full">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-yellow-400">⭐ <?php echo round($product["avg_rating"],1) ?> (<?php echo $product["review_count"] ?>)</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Navigation Buttons -->
             <button onclick="slideCarousel(-1);" class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-5 bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-all hover:scale-110 z-10 opacity-0 group-hover:opacity-100">❮</button>
             <button onclick="slideCarousel(1);" class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-5 bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-all hover:scale-110 z-10 opacity-0 group-hover:opacity-100">❯</button>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    ...
                    cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                            ...
                            <p class="font-semibold text-gray-800 group-hover:text-blue-600">Design</p></a>
                    <a href="#" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow-lg transition-all
                    cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                            <div class="text-5xl mb-3 group-hover:scale-110 transition-transform">💻</div>
                            <p class="font-semibold text-gray-800 group-hover:text-blue-600">Development</p></a>
                    <a href="#" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow-lg transition-all
                    cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                            <div class="text-5xl mb-3 group-hover:scale-110 transition-transform">📱</div>
                            <p class="font-semibold text-gray-800 group-hover:text-blue-600">Mobile</p></a>
                    <a href="#" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow-lg transition-all
                    cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                            <div class="text-5xl mb-3 group-hover:scale-110 transition-transform">📚</div>
                            <p class="font-semibold text-gray-800 group-hover:text-blue-600">Education</p> </a>
                    <a href="#" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow-lg transition-all
                    cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                            <div class="text-5xl mb-3 group-hover:scale-110 transition-transform">🎬</div>
                            <p class="font-semibold text-gray-800 group-hover:text-blue-600">Video</p></a>
                    <a href="#" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow-lg transition-all
                    cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                            <div class="text-5xl mb-3 group-hover:scale-110 transition-transform">💼</div>
                            <p class="font-semibold text-gray-800 group-hover:text-blue-600">Business</p></a>            
                </div>
            </div>
      </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <?php foreach($testimonials as $idx => $testimonial): ?>
                        <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-2xl transition-shadow hover:scale-105 duration-300">
                            <div class="flex items-center mb-4">
                                    ...
                                    <div> <p class="font-bold text-gray-900"><?php echo $testimonial["fname"] . " " . $testimonial["lname"]; ?> </p>
                                        <p class="text-sm text-yellow-400"><?php
                                                $stars = '';
                ...
                <?php else: ?>
                    <div class="bg-white rounded-lg shadow-lg p-8 text-center col-span-3">
                        <p class="text-gray-500">No testimonial yet. Be the first to leave a review!</p></div>
                <?php endif; ?>
            </div>                
       </section>
        ...
        <!-- How it works -->
         <section class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="text-center group">
                    <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full w-16 h-16 flex items-center
                     justify-center text-2xl text-white mx-auto mb-4 group-hover:scale-110 transition-transform">4</div> 
         ...
         <section class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 md:p-16 text-center text-white shadow-2xl">
                ...
                <p class="text-blue-100 text-lg mb-8">Join thousands of learners and sellers earning on SkillShop today</p>

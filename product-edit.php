...
if(!isset($_SESSION["logged_in"]) || $_SESSION["logged_in"] != true){ require_once "process/auth-check.php"; }
...
$productResult = Database::search("SELECT * FROM `product` WHERE `id`=? AND `seller_id`=?","ii", [$productId,$userId]);
...
if($categoryResult && $categoryResult->num_rows > 0){
    while($category = $categoryResult->fetch_assoc()){ $categories[] = $category; }
}
...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <form id="productForm" enctype="mutipart/form-data" class="p-8">
                    ...
                    <div class="mb-6">
                        ...
                        <input 
                            type="text" id="productTitle" name="productTitle" placeholder="Enter product title" maxlength="150"

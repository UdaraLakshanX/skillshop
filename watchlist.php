...
<div class="min-h-screen relative overflow-hidden">
    ...
    <section id="gridSection" class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16"> 
        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            ...
            <a href="search-products.php" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl
            font-semibold bg-white border-2 border-gray-200 text-gray-700 hover:border-blue-400 hover:text-blue-600
        ...
        <?php if(count($items) > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="watchlist-grid">
                ...
                ?>
                <article class="group relative bg-white/80 backdrop-blur rounded-2xl border border-gray-100 shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-300 hover:translate-y-1" data-product-id="<?= $p["id"]; ?>">
                    ...
                    <a href="product-view.php?id=<?= $p["id"]; ?>" class="block">
                        <div class="relative h-44 bg-gradient-to-br from-slate-100 to-slate-50 overflow-hidden">
                            ...
                            <span class="absolute top-3 left-3 px-3 py-1 bg-white/90 backdrop-blur
                            text-xs font-bold text-blue-700 rounded-lg shadow-sm"><?= $p["level"]; ?></span>
                        </div>   
                        ...
                        <div class="p-5">
                            ...
                            group-hover:text-blue-600 transition-colors"><?= $p["title"]; ?></h3>
                            <div class="flex items-center justify-between mt-4">
                                ...
                                text-transparent">Rs. <?= number_format($p["price"],2); ?></span>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="relative bg-white/80 backdrop-blur rounded-3xl border border-dashed
            border-gray-200 p-16 text-center shadow-lg max-w-xl mx-auto">
                <div class="inline-flex w-24 h-24 items-center justify-center rounded-full 
                bg-gradient-to-br from-rose-100 to-indigo-100 text-5xl mb-6">❤️</div>
